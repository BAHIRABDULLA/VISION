  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8">
        ...
        {/* Sign In Button */}
        <Button text="SIGN IN" onClick={handleSignIn} customClasses="bg-gradient-to-r from-pink-500 to-purple-600 w-1/2	 mt-6" />
        ...
        <button className="border border-gray-300 p-2 w-1/2	 flex items-center justify-center space-x-2">
