...
import { ChevronLeft, Star, MapPin, Clock, Calendar, Mail, Video, MessageSquare } from 'lucide-react';
import PricingOptions from '@/features/user/PricingOptions';
                        ...
                        <div className="bg-gray-800 rounded-lg p-6 flex flex-col md:flex-row gap-6 mb-8">
                            ...
                            <div className="flex-grow">
                                <div className="flex flex-col md:flex-row justify-between items-start">
                                    <div>
                                        <h1 className="text-2xl font-bold text-white">{mentor.fullName}</h1>
                                    ...
                                    <div className="mt-4 md:mt-0 md:text-right">
                                        ...
                                        <p className="text-xl font-bold text-white mt-2">{mentor.pricePerMonth}/month</p>
                                    </div>
                                </div>
                            ...
                            <div className="flex border-b border-gray-700">
                                {['about', 'experience', 'reviews'].map((tab) => (
                                    <button
                                        ...
                                        className={`flex-1 px-4 py-3 text-center capitalize ${
                                            activeTab === tab
                        ...
                        <div className="bg-gray-800 rounded-lg p-6">
                            {activeTab === 'about' && (
                                <div>
                                    ...
                                    <p className="text-gray-300 whitespace-pre-line">{mentor.longBio}</p>
                                    ...
                                    <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <p className="font-medium text-white">{mentor.yearsOfExperience}+ years</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-2">
