...
export interface IPaymentService {
    createSession(price: number, courseId: string,courseName:string, email: string, menteeId: string): Promise<{ id?: string; success: boolean; message: string } | null>;
    ...
    getUserBillingHistory(userId: string, role: 'mentee' | 'mentor'): Promise<any>
}
